...
<Request tabs="JavaScript,cURL,Python" show-lines="true">
  ```javascript
  const response = await fetch('https://api.fetchmedia.io/v1/videos/tiktok?url=https://www.tiktok.com/@user/video/123', {
    method: 'POST',
    headers: {
  ...
  ```bash
  curl -X POST https://api.fetchmedia.io/v1/videos/tiktok?url=https://www.tiktok.com/@user/video/123 \
  ...
  response = requests.post(
      'https://api.fetchmedia.io/v1/videos/tiktok',
      headers=headers,
