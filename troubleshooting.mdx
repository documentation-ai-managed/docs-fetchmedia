...
curl -H "X-API-Key: YOUR_API_KEY" \
  "https://api.fetchmedia.io/v1/fetch?url=https://www.tiktok.com/@user/video/123"
````
      </Step>
    </Steps>
  </Tab>
...
```javascript
const response = await fetch('https://api.fetchmedia.io/v1/process', {
  method: 'POST',
  headers: {
...
curl -X POST \
  ...
  https://api.fetchmedia.io/v1/process
````
</CodeGroup>
